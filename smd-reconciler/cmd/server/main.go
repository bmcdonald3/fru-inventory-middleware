...
import (
	...
	_ "github.com/openchami/smd-reconciler/pkg/apiversion"
	"github.com/openchami/fabrica/pkg/versioning"
	 ...
	 "github.com/openchami/smd-reconciler/internal/storage"
	
	

	
	"github.com/openchami/fabrica/pkg/events"
	"github.com/openchami/smd-reconciler/internal/subscriber"
...
var rootCmd = &cobra.Command{
	Use:   "smd-reconciler",
	Short: "",
	Long:  `smd-reconciler - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the smd-reconciler server",
	Long:  `Start the smd-reconciler HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.smd-reconciler.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".smd-reconciler")
	}

	// Environment variables
	viper.SetEnvPrefix("SMD-RECONCILER")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting smd-reconciler server...")
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "smd-reconciler.resource"
	}
	...
	// Initialize event subscriber for fru-tracker events
	log.Println("Initializing event subscriber...")
	fruTrackerURL := viper.GetString("fru_tracker_url")
	if fruTrackerURL == "" {
		fruTrackerURL = "http://fru-tracker:8080"
	}
	...
	fruClient := client.NewFruTrackerClient(fruTrackerURL)
	inventoryClient := client.NewInventoryClient(inventoryServiceURL)
	eventSubscriber := subscriber.NewSubscriber(fruClient, inventoryClient)

	// Start the event subscriber in a goroutine
	go func() {
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"smd-reconciler"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of smd-reconciler`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("smd-reconciler v1.0.0")
	},
}
